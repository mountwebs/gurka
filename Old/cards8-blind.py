...
class Game(object):
    ...
    def playRound(self):
        ...
        for x in range(len(self.players)):
            ...
            if x==0:
                ...
                print "{} played".format(self.players[x].name)
    ...
    #         firstCardValue.append(self.getValue(self.players[x].firstCard))
    #     print firstCardValue
